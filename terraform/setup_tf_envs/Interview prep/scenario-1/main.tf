...
# from generated_resources.tf 

resource "aws_instance" "example" {
  ami                                  = "ami-abcd12344d5f6ae949"
  ...
  security_groups                      = ["main-sg"]
  source_dest_check                    = true
  subnet_id                            = "subnet-012bf4e9274ff7b52"
  tags = {
  ...
  volume_tags                 = null
  vpc_security_group_ids      = ["sg-06ba6af0ed6757e68"]
